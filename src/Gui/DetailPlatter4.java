 ...
 * @author audreynaila
 */
public class DetailPlatter4 extends javax.swing.JFrame {

    /**
     * Creates new form DetailPlatter4
     */
    public DetailPlatter4() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Gambar/Detailpl4.png"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DetailPlatter4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DetailPlatter4().setVisible(true);
            }
        });
    }
